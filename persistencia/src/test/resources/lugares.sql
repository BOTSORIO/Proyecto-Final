...
insert into lugar(descripcion,estado,fecha_aprobacion,fecha_creacion,latitud,longitud,nombre,ciudad_id,moderador_id,tipo_id,usuario_id) values ("venta de computadores","abc","2021/02/04","2021/07/04",10,16,"Taquitos",1,"1",2,"2");
insert into lugar(descripcion,estado,fecha_aprobacion,fecha_creacion,latitud,longitud,nombre,ciudad_id,moderador_id,tipo_id,usuario_id) values ("Lugar de comida","twe","2021/04/04","2021/06/04",8,2,"Ya no se que poner",1,"1",3,"2");