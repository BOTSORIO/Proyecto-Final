...
insert into lugar(descripcion,estado,fecha_aprobacion,fecha_creacion,latitud,longitud,nombre,ciudad_id,moderador_id,tipo_id,usuario_id) values ("Lugar de comida","abc","2021/02/04","2021/07/04",10,16,"Taquitos",1,"1",1,"2");
